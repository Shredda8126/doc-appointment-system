      ...
      <CardContent>
        ...
        {!showForm ? (
              ...
              {slots.length === 0 ? (
                ...
                <div className="space-y-3">
                  {slots.map((slot) => (
                    <div
                      key={slot.id}
                      className="flex items-center p-3 rounded-md bg-muted/20 border border-violet-900/20"
                    >
                      <div className="bg-violet-900/20 p-2 rounded-full mr-3">
          ...
          <form
            ...
            className="space-y-4 border border-violet-900/20 rounded-md p-4"
          >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  className="bg-background border-violet-900/20"
                />
                {errors.startTime && (
        ...
        <div className="mt-6 p-4 bg-muted/10 border border-violet-900/10 rounded-md">
          <h4 className="font-medium text-white mb-2 flex items-center">
            <AlertCircle className="h-4 w-4 mr-2 text-violet-400" />
