        ...
        <Card className="border-violet-900/20">
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              ...
              <div className="bg-violet-900/20 p-3 rounded-full">
      ...
      <Card className="border-violet-900/20">
        <CardHeader>
          <CardTitle className="text-xl font-bold text-white flex items-center">
            <CreditCard className="h-5 w-5 mr-2 text-violet-400" />
            Payout Management
          </CardTitle>
        </CardHeader>
            ...
            <div className="space-y-2">
              ...
              <div className="space-y-2">
                {payouts.slice(0, 5).map((payout) => (
                  <div
                    key={payout.id}
                    className="flex items-center justify-between p-3 rounded-md bg-muted/10 border border-violet-900/10"
                  >
                    <div>
                      <p className="text-white font-medium">
        ...
        <DialogContent>
          ...
          <form onSubmit={handlePayoutRequest} className="space-y-4">
            <div className="bg-muted/20 p-4 rounded-lg space-y-2">
              ...
              <div className="border-t border-violet-900/20 pt-2 flex justify-between font-medium">
