...
export const features = [
  {
    icon: <User className="h-6 w-6 text-violet-400" />,
...
export const creditBenefits = [
  "Each consultation requires <strong class='text-violet-400'>2 credits</strong> regardless of duration",
  "Credits <strong class='text-violet-400'>never expire</strong> - use them whenever you need",
  "Monthly subscriptions give you <strong class='text-violet-400'>fresh credits every month</strong>",
  "Cancel or change your subscription <strong class='text-violet-400'>anytime</strong> without penalties",
];
